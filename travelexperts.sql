...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2016 at 01:18 PM
...
CREATE TABLE IF NOT EXISTS `agentlogin` (
...
INSERT INTO `agentlogin` (`username`, `agentId`, `password`) VALUES
('agent1', 1, 'agent1'),
('agent2', 2, 'agent2'),
('agent3', 3, 'agent3'),
('agent4', 4, 'agent4'),
...
INSERT INTO `agents` (`AgentId`, `AgtFirstName`, `AgtMiddleInitial`, `AgtLastName`, `AgtBusPhone`, `AgtEmail`, `AgtPosition`, `AgencyId`, `Active`) VALUES
(1, 'Janet', NULL, 'Delton', '(403) 210-7801', 'janet.delton@travelexperts.com', 'Senior Agent', 1, 1),
(2, 'Judy', NULL, 'Lisle', '(403) 210-7802', 'judy.lisle@travelexperts.com', 'Intermediate Agent', 1, 1),
(3, 'Dennis', 'C.', 'Reynolds', '(403) 210-7843', 'dennis.reynolds@travelexperts.com', 'Junior Agent', 1, 1),
(4, 'John', NULL, 'Coville', '(403) 210-7823', 'john.coville@travelexperts.com', 'Intermediate Agent', 1, 1),
(5, 'Janice', 'W.', 'Dahl', '(403) 210-7865', 'janice.dahl@travelexperts.com', 'Senior Agent', 1, 1),
(6, 'Bruce', 'J.', 'Dixon', '(403) 210-7867', 'bruce.dixon@travelexperts.com', 'Intermediate Agent', 2, 1),
(7, 'Beverly', 'S.', 'Jones', '(403) 210-7812', 'beverly.jones@travelexperts.com', 'Intermediate Agent', 2, 1),
(8, 'Jane', NULL, 'Merrill', '(403) 210-7868', 'jane.merrill@travelexperts.com', 'Senior Agent', 2, 1),
...
INSERT INTO `customerlogin` (`username`, `customerId`, `password`) VALUES
('cust1', 104, 'cust1'),
('cust10', 119, 'cust10'),
('cust11', 120, 'cust11'),
('cust12', 121, 'cust12'),
...
--
-- Constraints for table `agentlogin`
--
ALTER TABLE `agentlogin`
  ADD CONSTRAINT `agentlogin_ibfk_1` FOREIGN KEY (`agentId`) REFERENCES `agents` (`AgentId`);
